...
package com.example.panicwallpaper.databinding;
...
import com.example.panicwallpaper.R;
...
public final class ActivityMainBinding implements ViewBinding {
  ...
  @NonNull
  public final LinearLayout inputConfigContainer;
  ...
  private ActivityMainBinding(@NonNull ConstraintLayout rootView, @NonNull Button btnAdd,
      @NonNull ImageButton btnDate, @NonNull Button btnSetWallpaper, @NonNull EditText etTaskTitle,
      @NonNull LinearLayout inputConfigContainer, @NonNull KonfettiView konfettiView,
    ...
    this.inputConfigContainer = inputConfigContainer;
  ...
  public static ActivityMainBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.inputConfigContainer;
      LinearLayout inputConfigContainer = ViewBindings.findChildViewById(rootView, id);
      if (inputConfigContainer == null) {
        break missingId;
      }
      ...
      return new ActivityMainBinding((ConstraintLayout) rootView, btnAdd, btnDate, btnSetWallpaper,
          etTaskTitle, inputConfigContainer, konfettiView, recyclerView);
    }
