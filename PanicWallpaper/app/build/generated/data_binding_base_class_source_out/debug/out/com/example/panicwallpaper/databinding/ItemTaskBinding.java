...
public final class ItemTaskBinding implements ViewBinding {
  ...
  private ItemTaskBinding(@NonNull LinearLayout rootView, @NonNull CheckBox cbCompleted,
      @NonNull TextView tvDeadline, @NonNull TextView tvTitle) {
  ...
  public static ItemTaskBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ItemTaskBinding((LinearLayout) rootView, cbCompleted, tvDeadline, tvTitle);
    }
